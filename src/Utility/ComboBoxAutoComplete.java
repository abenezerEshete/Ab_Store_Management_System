...
public class ComboBoxAutoComplete extends Application {
    public static void main(String[] args) {
        launch();
    }

    public static <T> JFXComboBox<HideableItem<T>> createComboBoxWithAutoCompletionSupport(List<T> items) {
        ...
        JFXComboBox<HideableItem<T>> comboBox = new JFXComboBox<>();
    ...
    public void start(Stage stage) {
        ...
        List<Purchase> purchaseQuery = Main.getSession().createQuery(
                "from Purchase  ").getResultList();

        ComboBox<HideableItem<Purchase>> comboBox = createComboBoxWithAutoCompletionSupport(purchaseQuery);
